/* GET /how-it-works — serves the static Claude Design how-it-works HTML
   (public/how-it-works.html).

   Mirror of /command-center/route.ts but WITHOUT auth gate — this is
   a pre-sign marketing page. Middleware already allows /how-it-works
...
export async function GET() {
  const filePath = path.join(process.cwd(), "public", "how-it-works.html");
