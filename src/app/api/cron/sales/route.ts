    ...
    try {
      ...
      await resend.emails.send({
        ...
        html: `<div style="font-family:monospace;background:#03080f;color:#c8dff2;padding:24px;max-width:560px">
          <p style="color:#378ADD;font-size:10px;letter-spacing:.16em;text-transform:uppercase;margin-bottom:12px">FARaudit Sales AI · Daily</p>
          ...
          <div style="background:#06101a;border:1px solid rgba(255,255,255,.1);border-radius:6px;padding:14px;margin-bottom:12px">
            <p style="color:#378ADD;font-size:9px;letter-spacing:.12em;text-transform:uppercase;margin-bottom:6px">Rachel Prevost · American Valmark · Score 7.8</p>
            <p style="font-size:12px;color:#5a7fa0">4 messages sent · No reply yet · Check LinkedIn inbox now</p>
          </div>
          <div style="background:#06101a;border:1px solid rgba(255,255,255,.1);border-radius:6px;padding:14px;margin-bottom:12px">
            <p style="color:#378ADD;font-size:9px;letter-spacing:.12em;text-transform:uppercase;margin-bottom:6px">Today's outreach</p>
