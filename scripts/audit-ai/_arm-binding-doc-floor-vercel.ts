// ARM — AUDIT_BINDING_DOC_ANALYSIS_FLOOR = true on VERCEL PRODUCTION (Rule 17 parity with the audit-worker).
// CEO authorized in words 2026-08-02 ("arm it"), after PR #388 merged as 8335d1c.
//
...
const KEY = "AUDIT_BINDING_DOC_ANALYSIS_FLOOR";
