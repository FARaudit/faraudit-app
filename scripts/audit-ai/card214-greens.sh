...
for g in test-eligible-tristate test-procedural-coverage test-procedural-truncation test-keyfact-detector test-deadline-formats test-nmr-closedworld-spotcheck test-procurement-sections test-combined-synopsis-emit test-replay-harness test-precondition-overtype-floor test-flag-stack-interaction; do
