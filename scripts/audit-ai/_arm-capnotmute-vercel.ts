// ARM — AUDIT_COVERAGE_CAP_NOT_MUTE=true on VERCEL PRODUCTION (Rule 17 parity with the audit-worker). CEO in-words authorized 2026-07-29.
...
const KEY = "AUDIT_COVERAGE_CAP_NOT_MUTE";
