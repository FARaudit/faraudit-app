// $0 CERT-3 PRE-SCREEN + NEW-STYLE CENSUS — N0016726Q1089 (Navy CWRG battery, ~4 docs, SB). #503 seq target #3.
//   npx dotenv -e .env.local -- npx tsx scripts/audit-ai/_prescreen-N0016726Q1089.ts
