// ARM — AUDIT_PROFILE_SCHEMA_V2=true on VERCEL PRODUCTION (Rule 17 parity; capture stays OFF). CEO in-words authorized 2026-07-29.
...
const KEY = "AUDIT_PROFILE_SCHEMA_V2";
